...
public enum AdminCategoryDeleteStatus { Deleted, NotFound, InUse }
...
public enum AdminLearningPathCategoryDeleteStatus { Deleted, NotFound, InUse }
...
public enum AdminQuestionDeleteStatus { Deleted, NotFound }
