...
public interface ILocalizedUrlService { Task<LocalizedUrlSet> ResolveAsync(HttpContext context); PublicNavigationUrlSet GetPublicNavigation(); }
public sealed class LocalizedUrlService : ILocalizedUrlService {
 ...
 [ActivatorUtilitiesConstructor] public LocalizedUrlService(ILocalizedSlugQueries queries, ICurrentLanguageService? language=null){_queries=queries;_language=language??new CurrentLanguageService();}
